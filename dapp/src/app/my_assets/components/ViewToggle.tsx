// src/app/my_assets/components/ViewToggle.tsx
...
export const ViewToggle = ({ viewMode, setViewMode }: ViewToggleProps) => (
  <div className="flex gap-1 bg-[#0D0E29] rounded-md p-1">
    <button
      onClick={() => setViewMode('grid')}
      className={`p-1 rounded ${viewMode === 'grid' ? 'bg-[#06071B]' : ''}`}
    >
    ...
    <button
      ...
      className={`p-1 rounded ${viewMode === 'list' ? 'bg-[#06071B]' : ''}`}
    >
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 16 16">
